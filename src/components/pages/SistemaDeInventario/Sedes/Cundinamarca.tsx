...
//*Images
import Sede01 from "../Images/SEDE-01-cundinamarca.webp";
import Sede03 from "../Images/SEDE-03-cundinamarca.webp";
import Sede04 from "../Images/SEDE-04-cundinamarca.webp";
import Sede05 from "../Images/SEDE-05-cundinamarca.webp";
  ...
  return (
    <>
      ...
      <div className="w-full p-5 ml-0 bg-white rounded-md shadow-lg dark:bg-gray-800 mb-11 shadow-indigo-500/40">
        ...
        {/* Sedes Cundinamarca 01*/}
        <div className="grid grid-cols-2 gap-12">
          <NavLink to="/SistemaDeInventario/Cundinamarca/Sede01C">
                ...
                <div className="flex justify-between space-x-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <span className="ml-3">La Mesa</span>
                    </div>
                  </div>
                  <div className="flex items-center">
          ...
          <NavLink to="/SistemaDeInventario/Cundinamarca/Sede03C">
            {/* Sedes Cundinamarca 02 */}
            <div className="relative w-full p-8 mx-auto overflow-hidden text-gray-900 duration-300 ease-in-out bg-gray-200 rounded-lg cursor-pointer dark:bg-gray-900 dark:text-gray-100 hover:-translate-y-1">
              {/* Imagen de fondo */}
              <div className="absolute top-0 left-0 h-full w-72">
                <img
                ...
                <div className="flex justify-between space-x-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <span className="ml-3">Ubaté</span>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <button className="flex p-2 text-sm text-white bg-gray-700 rounded-full dark:bg-teal-600">
          ...
          <NavLink to="/SistemaDeInventario/Cundinamarca/Sede04C">
            {/* Sedes Cundinamarca 03 */}
            <div className="relative w-full p-8 mx-auto overflow-hidden text-gray-900 duration-300 ease-in-out bg-gray-200 rounded-lg cursor-pointer dark:bg-gray-900 dark:text-gray-100 hover:-translate-y-1">
              {/* Imagen de fondo */}
              <div className="absolute top-0 left-0 h-full w-72">
                <img
                ...
                <div className="flex justify-between space-x-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <span className="ml-3">Cajicá</span>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <button className="flex p-2 text-sm text-white bg-gray-700 rounded-full dark:bg-teal-600">
          ...
          <NavLink to="/SistemaDeInventario/Cundinamarca/Sede05C">
            {/* Sedes Cundinamarca 04 */}
            <div className="relative w-full p-8 mx-auto overflow-hidden text-gray-900 duration-300 ease-in-out bg-gray-200 rounded-lg cursor-pointer dark:bg-gray-900 dark:text-gray-100 hover:-translate-y-1">
              {/* Imagen de fondo */}
              <div className="absolute top-0 left-0 h-full w-72">
                <img
                ...
                <div className="flex justify-between space-x-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <span className="ml-3">La Calera</span>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <button className="flex p-2 text-sm text-white bg-gray-700 rounded-full dark:bg-teal-600">
