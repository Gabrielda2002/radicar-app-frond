        ...
        <section>
          ...
          <div className="w-full bg-white shadow-lg transform transition-transform duration-300 overflow-hidden rounded">
            ...
            <section className="p-6 max-h-[70Vh] overflow-y-auto grid grid-cols-2  mb-4 ms-2">
              <div className="flex">
                <label htmlFor="" >
                  <span className="flex mb-2 font-bold text-gray-700 after:content-['*'] after:ml-2 after:text-red-600 dark:text-white dark:bg-gray-700" >Estado Seguimiento</span>
                  <select  id="" name="" className="w-[200px] px-3 py-2 border border-gray-200 rounded dark:border-gray-600 text-stone-700 dark:text-white dark:bg-gray-700" >
              ...
              <div>
                <label htmlFor="">
                  <span className="flex mb-2 font-bold text-gray-700 after:content-['*'] after:ml-2 after:text-red-600 dark:text-white dark:bg-gray-700" >Observación</span>
                  <textarea id="" name="" className="w-[300px] px-3 py-2 border border-gray-200 rounded dark:border-gray-600 text-stone-700 dark:text-white dark:bg-gray-700"></textarea>
                </label>
              </div>
            </section>

            {/* container-footer */}
            <div className="flex  items-center justify-end w-full h-14 gap-1 px-4 py-4 text-sm font-semibold  bg-white dark:bg-gray-800">
              <button
