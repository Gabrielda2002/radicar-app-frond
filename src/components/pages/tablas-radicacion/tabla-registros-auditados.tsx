...
import ModalActualizarCupsAuditoria from "../modals/modal-actualizar-cups-auditados";
...
const TablaRegistrosAuditados = () => {
  return (
    <>
      ...
      <section className="w-full p-5 bg-white ml-0 rounded-md shadow-lg dark:bg-gray-800 mb-11 shadow-indigo-500/40">
        <label 
            htmlFor="" 
