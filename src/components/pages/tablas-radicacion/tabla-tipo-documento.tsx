...
const TablaTipoDocumento = () => {
  return(
    <>
        ...
        <section> 
            <h1 className="text-color text-4xl mb-4 ">Módulo Tipo Documento</h1>
            <nav>
        ...
        <section className="container-table bg-white p-5 mb-11 shadow-lg shadow-indigo-500/40 rounded-md">
            ...
            <section className="header-tabla pb-6 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2 pt-1">
                    ...
                    <button className="borde-2 w-[200px] h-[40px] rounded-md focus:outline-none bg-color text-white hover:bg-emerald-900  active:bg-emerald-800 ">
            ...
            <table className="text-sm mx-auto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="break-words">TI</td>
                        <td className="break-words">...texto alusivo </td>
                        <td className="break-words">
                            <button>
                                <img src={onOff} alt="" />
