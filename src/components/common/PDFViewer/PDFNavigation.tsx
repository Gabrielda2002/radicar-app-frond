    ...
    <div className="fixed w-full h-12 bottom-0 right-0 z-50 pointer-events-none">
      <div className="flex justify-center ">
        ...
        >
          ...
          <span className="relative inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-slate-700 ring-0 ring-inset ring-slate-700 bg-slate-50 min-w-[80px] pointer-events-auto dark:bg-gray-700 dark:text-gray-200">
            {pageNumber} / {numPages}
          </span>
