...
const RegistrarUsuarios = lazy(() => import("@/featuures/RegisterUser/Page/RegisterUser.tsx"));
...
const TablaAuditoria = lazy(() => import("@/featuures/Auditoria/Pages/TablaAuditoria.tsx"));
const TablaRadicacion = lazy(() => import("@/featuures/Radicacion/Page/TablaRadicacion.tsx"));
const TablaAutorizarServicios = lazy(() => import("@/featuures/AuthorizeService/Pages/TablaAutorizarServicios.tsx"));
const FileManager = lazy(() => import("@/featuures/SystemGC/Page/SistemaArchivosSGC.tsx"));
const SistemaInventario = lazy(() => import("@/featuures/SystemInventory/Pages/InventorySystem.tsx"));
const RegistroUsuarios = lazy(() => import("@/featuures/UserRegister/Page/RegistroUsuario.tsx"));
const GestionTickets = lazy(() => import("@/featuures/HelpDesk/Pages/ProcessHelpDesk.tsx"));
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/tabla-autorizar-servicios" element={<TablaAutorizarServicios />} />
