...
const ModalUpdateCupsDiagnostico = lazy(
  () =>
    import(
      "@/components/common/Modals/UpdateDiagCUPS/ModalUpdateCupsDiagnostico"
    )
);
const ModalCrearCupsDiagnostico = lazy(
  () =>
    import(
      "@/components/common/Modals/CreateDiagCUPS/ModalCrearCupsDiagnostico"
    )
);
      ...
      <DataTableContainer
        ...
        headerActions={
          <Suspense fallback={<LoadingSpinner />}>
            <ModalCrearCupsDiagnostico modulo="CUPS" onSuccess={refetch} />
          </Suspense>
        }
      >
        <DataTable
