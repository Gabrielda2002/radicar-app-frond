...
export const ipsPrimariaForm: TableFormConfig = {
  endPoint: "create-ips-primaria",
  updateEndPoint: "update-status-ips-primaria",
  create: {
    fields: [
      {
        name: "name",
        label: "Nombre IPS Primaria",
        type: "text",
        required: true,
      },
    ],
  ...
  edit: {
    fields: [
      { name: "id", label: "ID IPS Primaria", type: "text", readOnly: true },
