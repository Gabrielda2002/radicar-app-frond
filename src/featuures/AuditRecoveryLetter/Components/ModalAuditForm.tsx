              ...
              <div>
                <label htmlFor="observation">
                  ...
                  {formik.touched.observation && formik.errors.observation ? (
                    <div className="text-red-600">{formik.errors.observation}</div>
                  ) : null}
                </label>
              </div>

                  <div className="grid grid-cols-2 gap-4 mt-4">
                    { cupsAuthorized && formik.values.cups.map(cup => (
                        <div 
                        key={cup.id}
                        className="w-full p-4 mx-1 border rounded-md shadow-md"
                        >
                            <div
                                className="mb-4"
                            >
                                ...
                                <input
                                 ...
                                 value={cup.code}
                                 readOnly
                                 className="w-full p-2 border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                 />
                            </div>
                            <div className="mb-4">
                              <label className="mb-2 font-medium text-stone-600 dark:text-stone-300">
