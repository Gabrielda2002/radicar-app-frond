    ...
    <>
      <div className="flex flex-col w-full p-6 pb-10 mb-10 border-2 rounded-lg shadow-md dark:border-color bg-gray-50 dark:bg-gray-700 dark:shadow-indigo-800">
        <div className="flex justify-start">
          <h2 className="mb-5 text-2xl font-bold md:text-[33px] dark:text-white">
        ...
        <div className="flex flex-col ">
          ...
          <div>
            <input
              ...
              className="p-2 mt-3 mr-4 border-2 border-gray-400 rounded-lg b-2 w-44 md:w-60 dark:text-gray-700 text-[17px]"
            />
            <button 
            type="button" 
